...
Install Harbor DB without Node.js, npm, or a source checkout. Download version **0.1.10** for your computer:

| Platform                   | Downloads                                                                                                                                                                                                                                           |
| -------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Linux (64-bit Intel/AMD) | [DEB](https://github.com/aligeek-tech/harbor-db/releases/download/v0.1.10/Harbor-DB-0.1.10-linux-amd64.deb) · [RPM](https://github.com/aligeek-tech/harbor-db/releases/download/v0.1.10/Harbor-DB-0.1.10-linux-x86_64.rpm) · [AppImage](https://github.com/aligeek-tech/harbor-db/releases/download/v0.1.10/Harbor-DB-0.1.10-linux-x86_64.AppImage) · [Portable archive](https://github.com/aligeek-tech/harbor-db/releases/download/v0.1.10/Harbor-DB-0.1.10-linux-x64.tar.gz) |
| Linux (ARM64) | [DEB](https://github.com/aligeek-tech/harbor-db/releases/download/v0.1.10/Harbor-DB-0.1.10-linux-arm64.deb) · [RPM](https://github.com/aligeek-tech/harbor-db/releases/download/v0.1.10/Harbor-DB-0.1.10-linux-aarch64.rpm) · [AppImage](https://github.com/aligeek-tech/harbor-db/releases/download/v0.1.10/Harbor-DB-0.1.10-linux-arm64.AppImage) · [Portable archive](https://github.com/aligeek-tech/harbor-db/releases/download/v0.1.10/Harbor-DB-0.1.10-linux-arm64.tar.gz) |
| Windows (64-bit Intel/AMD) | [Setup (.exe)](https://github.com/aligeek-tech/harbor-db/releases/download/v0.1.10/Harbor-DB-0.1.10-win-x64.exe)                                                                                                                                      |
| macOS 13+ (Apple Silicon)  | [Installer (.dmg)](https://github.com/aligeek-tech/harbor-db/releases/download/v0.1.10/Harbor-DB-0.1.10-mac-arm64.dmg) · [ZIP](https://github.com/aligeek-tech/harbor-db/releases/download/v0.1.10/Harbor-DB-0.1.10-mac-arm64.zip)                      |
| macOS 13+ (Intel)          | [Installer (.dmg)](https://github.com/aligeek-tech/harbor-db/releases/download/v0.1.10/Harbor-DB-0.1.10-mac-x64.dmg) · [ZIP](https://github.com/aligeek-tech/harbor-db/releases/download/v0.1.10/Harbor-DB-0.1.10-mac-x64.zip)                          |

[All releases and release notes](https://github.com/aligeek-tech/harbor-db/releases/latest) · [SHA-256 checksums](https://github.com/aligeek-tech/harbor-db/releases/download/v0.1.10/SHA256SUMS)
