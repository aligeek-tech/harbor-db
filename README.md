...
Install Harbor DB without Node.js, npm, or a source checkout. Download version **0.1.6** for your computer:

| Platform                   | Downloads                                                                                                                                                                                                                                           |
| -------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Linux (64-bit Intel/AMD)   | [Debian / Ubuntu (.deb)](https://github.com/aligeek-tech/harbor-db/releases/download/v0.1.6/Harbor-DB-0.1.6-linux-amd64.deb) · [AppImage](https://github.com/aligeek-tech/harbor-db/releases/download/v0.1.6/Harbor-DB-0.1.6-linux-x86_64.AppImage) |
| Windows (64-bit Intel/AMD) | [Setup (.exe)](https://github.com/aligeek-tech/harbor-db/releases/download/v0.1.6/Harbor-DB-0.1.6-win-x64.exe)                                                                                                                                      |
| macOS 13+ (Apple Silicon)  | [Installer (.dmg)](https://github.com/aligeek-tech/harbor-db/releases/download/v0.1.6/Harbor-DB-0.1.6-mac-arm64.dmg) · [ZIP](https://github.com/aligeek-tech/harbor-db/releases/download/v0.1.6/Harbor-DB-0.1.6-mac-arm64.zip)                      |
| macOS 13+ (Intel)          | [Installer (.dmg)](https://github.com/aligeek-tech/harbor-db/releases/download/v0.1.6/Harbor-DB-0.1.6-mac-x64.dmg) · [ZIP](https://github.com/aligeek-tech/harbor-db/releases/download/v0.1.6/Harbor-DB-0.1.6-mac-x64.zip)                          |

[All releases and release notes](https://github.com/aligeek-tech/harbor-db/releases/latest) · [SHA-256 checksums](https://github.com/aligeek-tech/harbor-db/releases/download/v0.1.6/SHA256SUMS)
